...
[[ -z $1 ]] && rt='adm-lite' || rt='ADMcgh'
    clear&&clear
    msg -bar
    echo -e "\033[1;44;44m   \033[1;33m=====>>►► | Drowkbot◄◄<<=====  \033[0m \033[0;33m[$(less /etc/${rt}/v-local.log)]"
    msg -bar
}
in_opcion(){
  unset opcion
...
wget -q -O /usr/bin/gerar https://gist.githubusercontent.com/drowkid-1/6baa981cd342c5d1feb0bce7eddf7e13/raw/fb9efd17a83119760b851fcda78d79ec078b2581/gerador.sh && chmod +x /usr/bin/gerar
cd $HOME
